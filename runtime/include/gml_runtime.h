...
GMLFN(ps4_touchpad_mouse_enable); GMLFN(texture_flush);
...
GMLFN(audio_system_is_available);
GMLFN(array_create_ext); GMLFN(array_shuffle); GMLFN(buffer_seek);
GMLFN(device_mouse_check_button); GMLFN(device_mouse_check_button_pressed);
GMLFN(device_mouse_dbclick_enable); GMLFN(device_mouse_x_to_gui); GMLFN(device_mouse_y_to_gui);
GMLFN(display_set_gui_maximize); GMLFN(display_set_gui_size);
